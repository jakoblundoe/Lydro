...
public class AudioEmitter : MonoBehaviour
{
    ...
    public void SetLocalParamToZero()
    {
        if (localParamName != null && eventInstance.isValid())
        {
            eventInstance.setParameterByName(localParamName, 0);
        }
    }

    public void SetLocalParamToOne()
    {
        if (localParamName != null && eventInstance.isValid())
        {
            eventInstance.setParameterByName(localParamName, 1);
        }
    }

    public void SetLocalParamToTwo()
    {
        if (localParamName != null && eventInstance.isValid())
        {
            eventInstance.setParameterByName(localParamName, 2);
        }
    }

    public void SetLocalParamToThree()
    {
        if (localParamName != null && eventInstance.isValid())
        {
            eventInstance.setParameterByName(localParamName, 3);
        }
    }
