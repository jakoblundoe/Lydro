...
public class RaycastEventDown : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        RaycastControl.RaycastHit03 += StartTimedSoundEvent;
        RaycastControl.RaycastHit03 += SetGlobalParameter;
        RaycastControl.RaycastHit02 += StopSoundEvent;
    }
